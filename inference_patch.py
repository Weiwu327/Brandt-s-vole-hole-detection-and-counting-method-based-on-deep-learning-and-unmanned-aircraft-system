...
parser.add_argument('--input_path', default='../VOCdevkit/test_bigimg', type=str, help='path to input images')
parser.add_argument('--output_path', default='./output/test_bigimg_results_0.5/', type=str, help='path to output results')
...
if __name__ == "__main__":
    ...
    for image_path in tqdm(image_ids):
        ...
        for image_path in glob.glob(osp.join(voc_subimgs_path, "*.jpg")):
            ...
            fcos.get_map_txt(image_id2, image, class_names, txt_path)
